...
- Run `/login` and select **xAI (SuperGrok / X Premium)** to authenticate with a SuperGrok or X Premium subscription
- `XAI_API_KEY` remains available through the API key login
